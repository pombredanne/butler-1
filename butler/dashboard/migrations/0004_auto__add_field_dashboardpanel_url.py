...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DashboardPanel.url'
        db.add_column(u'dashboard_dashboardpanel', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DashboardPanel.url'
        db.delete_column(u'dashboard_dashboardpanel', 'url')
